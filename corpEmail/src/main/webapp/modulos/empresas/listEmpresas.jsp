<%@page import="models.conectionEmpresas"%>
<%-- 
        Document   : inicio.jsp
        Created on : 22/05/2021, 21:32:41
        Author     : agr12
--%>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="box-body">
                                                <table role="grid" class="table dt-responsive nowrap table-striped table-bordered display table-sm tb-responsive tablasGeneral" cellspacing="0" >
                                                    ...
                                                    <%
                                                        conectionEmpresas conexionEmpresa = new conectionEmpresas();
                                                        controladorServletEmpresa.ArrayOfString dataEmpresa = conexionEmpresa.AllEmpresas();

                                                        int contador = 0;
                                                        for (String s : dataEmpresa.getString()) {
                                                            contador++;
                                                        }
                                                        ...
                                                        if (iterador == 2) {
                                                            out.println("<tbody><td>1</td>");
                                                            out.println("<td>" + dataEmpresa.getString().get(0) + "</td>");
                                                            out.println("<td>" + dataEmpresa.getString().get(1) + "</td>");
                                                            out.println("<td>" + dataEmpresa.getString().get(2) + "</td>");
                                                            out.println("<td>" + dataEmpresa.getString().get(3) + "</td>");
                                                            out.println("<td>" + dataEmpresa.getString().get(4) + "</td>");
                                                                    out.println("<td><div class='btn-group btn-sm'><a type='button' class='btn btn-outline-warning btnEditUser' href='editarEmpresa.jsp?idEmpresa=" + dataEmpresa.getString().get(5) + "'><i class='fa fa-edit'></i></a><a type='button' class='btn btn-outline-danger btn-sm btnDelete' href='eliminarEmpresa.jsp?idEmpresa=" + dataEmpresa.getString().get(5) + "'><i class='fa fa-trash'></i></a></div></td>");

                                                            out.println("<td>" + dataEmpresa.getString().get(6) + "</td></tbody>");
                                                                    out.println("<tbody><td>2</td>");
                                                                    out.println("<td>" + dataEmpresa.getString().get(7) + "</td>");
                                                                    out.println("<td>" + dataEmpresa.getString().get(8) + "</td>");
                                                                    out.println("<td>" + dataEmpresa.getString().get(9) + "</td>");
                                                                    out.println("<td>" + dataEmpresa.getString().get(10) + "</td>");
                                                                    out.println("<td>" + dataEmpresa.getString().get(11) + "</td>");                                                                    
                                                                    out.println("<td><div class='btn-group btn-sm'><a type='button' class='btn btn-outline-warning btnEditUser' href='editarEmpresa.jsp?idEmpresa=" + dataEmpresa.getString().get(12) + "'><i class='fa fa-edit'></i></a><a type='button' class='btn btn-outline-danger btn-sm btnDelete' href='eliminarEmpresa.jsp?idEmpresa=" + dataEmpresa.getString().get(12) + "'><i class='fa fa-trash'></i></a></div></td>");

                                                                    out.println("<td>" + dataEmpresa.getString().get(13) + "</td></tbody>");  
                                                        }else{
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; 2021 <a href="#">Corporación capsula</a>.</strong>
                All rights reserved.
