                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nombreReq" value="" placeholder="Ingresa Nombre de Empresa" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <input type="text" class="form-control"name="nitReq" value="" placeholder="Ingrese Nit de Empresa" />
                                    </div>
                                    
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <input type="text" class="form-control"name="dominioReq" value="" placeholder="Ingrese Dominio de Empresa" />
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <input type="text" class="form-control"name="telReq" value="" placeholder="Ingrese Telefono de Empresa" />
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <input type="text" class="form-control"name="direccionReq" value="" placeholder="Ingrese Direccion de Empresa" />
                                    </div>        
                                    <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                        <button type="submit" class="btn btn-outline-primary btn-block">Guardar Empresa <i class="fas fa-save"></i></button>
                                    </div>                                   
                                </div>
                            </form>
                            <!-- /.row -->
