                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                <input class="form-control" type="text" placeholder="Ingrese el correo" value="">
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 mt-4">
                                <center><button type="button" class="btn btn-success">Recupera Password <i class="fa fa-resolving"></button></center>
                            </div>
